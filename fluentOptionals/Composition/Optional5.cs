...
namespace FluentOptionals.Composition
{
        ...
        IEquatable<Optional<T1, T2, T3, T4, T5>>
    {
        ...
        {
            return new Optional<T1, T2, T3, T4, T5, T6>(_o1, _o2, _o3, _o4, _o5, Optional.From(valueToJoin));
        }

        public Optional<T1, T2, T3, T4, T5, T6> Join<T6>(T6 valueToJoin, Func<T6, bool> condition)
        {
            return new Optional<T1, T2, T3, T4, T5, T6>(_o1, _o2, _o3, _o4, _o5, Optional.From(valueToJoin, condition));
        }

        public Optional<T1, T2, T3, T4, T5, T6> Join<T6>(Optional<T6> optionalToJoin)
        {
            return new Optional<T1, T2, T3, T4, T5, T6>(_o1, _o2, _o3, _o4, _o5, optionalToJoin);
        }
